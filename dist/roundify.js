...
var Legend = function Legend() {
    ...
    this.constructLegend = function constructLegend(data, colors) {
        ...
        data.forEach(function(serie, k) {
            ...
            lines.add(paper.g(pict, text, result));
            posy += parseInt(_this.configs.font.fontSize) * 2;
        });
    ...
    /**
     * Créer l'element de wrapper de la légende
     */
    function getWrapperLegend() {
        //return paper.rect(_this.configs.pos.x, _this.configs.pos.y - 50, 100, 100);
    }
 ...
 * @param {Object} configs
 */
var RoundifyCircle = function RoundifyCircle() {
    ...
    this.init = function(_data, configs) {
        ...
        // 3. Construit les arcs composant le cercle
        data.forEach(function(v, k) {
            _this.arcs.push(new Arc(v, _this.configs.nowPoint, _this.configs.colors[k], _this.configs));
            _this.configs.nowPoint = _this.arcs[k].getEndPoint();
        });
 ...
 * @param {Object} configs
 */
var Arc = function Arc(data, from, color, configs) {
